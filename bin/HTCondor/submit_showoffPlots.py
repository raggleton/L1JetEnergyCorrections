...
"""
CONFIGS.extend([
    {'input': '/hdfs/L1JEC/CMSSW_8_0_2/L1JetEnergyCorrections/Stage2_HF_QCDFall15_1Apr_int-v14_dummyLayer1_L1JECSpring15_jst1p5_RAWONLY/check/check_QCDFlatFall15NoPU_MP_ak4_ref10to5000_l10to5000_dr0p4_spring15JEC_maxPt1022.root',
     'type': '--checkcal',
     'args': '--detail',
     'title': 'Fall15 MC, 0PU, Stage 2 + dummy Layer 1, old L1JEC, JST 1.5 GeV',
     'dest': None},
    {'input': '/hdfs/L1JEC/CMSSW_8_0_2/L1JetEnergyCorrections/Stage2_HF_QCDFall15_1Apr_int-v14_dummyLayer1_L1JECSpring15_jst1p5_RAWONLY/check/check_QCDFlatFall15PU0to50NzshcalRaw_MP_ak4_ref10to5000_l10to5000_dr0p4_spring15JEC_PU0to10_maxPt1022.root',
     'type': '--checkcal',
     'args': '--detail',
     'title': 'Fall15 MC, PU0-10, Stage 2 + dummy Layer 1, old L1JEC, JST 1.5 GeV',
     'dest': None},
    {'input': '/hdfs/L1JEC/CMSSW_8_0_2/L1JetEnergyCorrections/Stage2_HF_QCDFall15_1Apr_int-v14_dummyLayer1_L1JECSpring15_jst1p5_RAWONLY/check/check_QCDFlatFall15PU0to50NzshcalRaw_MP_ak4_ref10to5000_l10to5000_dr0p4_spring15JEC_PU15to25_maxPt1022.root',
     'type': '--checkcal',
     'args': '',
     'title': 'Fall15 MC, PU15-25, Stage 2 + dummy Layer 1, old L1JEC, JST 1.5 GeV',
     'dest': None},
    {'input': '/hdfs/L1JEC/CMSSW_8_0_2/L1JetEnergyCorrections/Stage2_HF_QCDFall15_1Apr_int-v14_dummyLayer1_L1JECSpring15_jst1p5_RAWONLY/check/check_QCDFlatFall15PU0to50NzshcalRaw_MP_ak4_ref10to5000_l10to5000_dr0p4_spring15JEC_PU30to40_maxPt1022.root',
     'type': '--checkcal',
     'args': '--detail',
     'title': 'Fall15 MC, PU30-40, Stage 2 + dummy Layer 1, old L1JEC, JST 1.5 GeV',
     'dest': None}
])
"""
